<div class="page-header">
	<h1><?php echo $this->Html->link(__('Group'), array('action' => 'index')); ?></h1>
</div>
...
<div class="panel panel-default">
  	...
  	<div class="panel-body">
		...
		<div class='row'>
			...
			<span class='col-md-9'><?php echo h($group['Group']['created']); ?></span>
		</div>
		<div class='row'>
			<span class='col-md-3'><?php echo __('Modified'); ?></span>
			<span class='col-md-9'><?php echo h($group['Group']['modified']); ?></span>
		</div>
