<div class="armyLists index">
    <div class="row">
        <h2 class="span6"><?php echo __('Army Lists');?></h2>
	...
	<table class="table table-striped table-bordered table-listings" data-sort-url="<?php echo Router::url(array('controller' => 'armyLists', 'action' => 'save_order')); ?>">
		...
		<tbody>
			...
			<tr id="armyLists-<?php echo $armyList['ArmyList']['id']; ?>" data-id="<?php echo $armyList['ArmyList']['id']; ?>">
								...
								<td><?php echo $this->Html->link($armyList['Races']['id'], array('controller' => 'races', 'action' => 'view', $armyList['Races']['id'])); ?></td>
								<td><?php echo $this->Html->link($armyList['Users']['id'], array('controller' => 'users', 'action' => 'view', $armyList['Users']['id'])); ?></td>
								<td><?php echo h($armyList['ArmyList']['created']); ?></td>
								<td><?php echo h($armyList['ArmyList']['modified']); ?></td>
								<td class="actions">
					<?php echo $this->Html->link(__('View'), array('action' => 'view', $armyList['ArmyList']['id']), array('class' => 'icon icon-eye')); ?>
					<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $armyList['ArmyList']['id']), array('class' => 'icon icon-edit')); ?>
					<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $armyList['ArmyList']['id']), array('class' => 'icon icon-delete'), __('Are you sure you want to delete this record?')); ?>
				</td>
			</tr>
			<?php } ?>
		</tbody>
